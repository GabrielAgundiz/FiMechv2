...
import 'package:fimech/screens/user/diagnosticComplete.dart';
import 'package:fimech/screens/user/widgets/verticalstepper.dart'
    as step;
import 'package:fimech/screens/user/widgets/verticalstepper.dart';
import 'package:fimech/services/appointment_service.dart';

class TrackDetailsPageComplete extends StatefulWidget {
  final Appointment _appointment;
  TrackDetailsPageComplete(this._appointment, {super.key});

  @override
  State<TrackDetailsPageComplete> createState() =>
      _TrackDetailsPageCompleteState();
}

class _TrackDetailsPageCompleteState extends State<TrackDetailsPageComplete> {
